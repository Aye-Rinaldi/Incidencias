...
incidencias que se producen en sus PCs. Cada incidencia tiene un
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        inc2.resuelveTarea("El equipo no estaba enchufado");
        inc3.resuelveTarea("Cambio del cable VGA");
